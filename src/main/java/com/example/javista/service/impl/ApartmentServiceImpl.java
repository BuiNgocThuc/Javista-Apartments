...
public class ApartmentServiceImpl implements ApartmentService {
    ...
    public ApartmentResponse getApartmentById(String id) {
        return apartmentMapper.entityToResponse(
                apartmentRepository.findById(id).orElseThrow(() -> new RuntimeException("Apartment Not Found")));
    }
