...
public interface RelationshipRepository
    ...
    @Query("SELECT r FROM Relationship r " + "INNER JOIN fetch r.apartment a "
            + "INNER JOIN r.user u "
    ...
    List<Relationship> findDelinquentOwners(
            @Param("ownerRole") RelationshipRole ownerRole, @Param("overdueStatus") BillStatus overdueStatus);
}
